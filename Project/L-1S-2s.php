...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Level-1 Semester-2</title>
  ...
  <body>
    ...
    <h2> Level: 1 </h2>
    <h2> Semester: 2 </h2>
    <h2> Total Credit Hour: <strong>20.75</strong></h2>
    <div class="col">
      <ul class="course">
        <li class="header">Physics</li>
        <li class="emph"><strong>Course Title: </strong> Physics-II</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>PHY-121</li>
    ...
    <div class="col">
      <ul class="course">
        <li class="header">LCM</li>
        <li class="emph"><strong>Course Title: </strong> Communicative English</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>LCM-121</li>
        <li><strong>Credit Hour: </strong>2.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        <li class="header">Mathematics</li>
        <li class="emph"><strong>Course Title: </strong> Mathematics-II</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>MAT-121</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        <li class="header">Electrical Engineering</li>
        <li class="emph"><strong>Course Title: </strong>Electronic Device & Circuits</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>EEE-121</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        ...
        <li class="emph"><strong>Course Title: </strong>Discrete Mathematics</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>CIT-121</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        ...
        <li class="emph"><strong>Course Title: </strong> Object Oreiented Programming</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>CCE-121</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        ...
        <li><strong>Course Code: </strong>PHY-122</li>
        <li><strong>Credit Hour: </strong>0.75</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        ...
        <li class="emph"><strong>Course Title: </strong>Electronic Device & Circuits</li>
        <li><strong>Status: </strong>Sessional</li>
        <li><strong>Course Code: </strong>EEE-122</li>
    ...
    <div class="col">
      <ul class="course">
        ...
        <li class="emph"><strong>Course Title: </strong> Object Oreiented Programming</li>
        <li><strong>Status: </strong>Sessional</li>
        <li><strong>Course Code: </strong>CCE-122</li>
        <li><strong>Credit Hour: </strong>1.50</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
