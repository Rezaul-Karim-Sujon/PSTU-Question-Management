...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Level-2 Semester-2</title>
  ...
  <body>
    ...
    <h2> Level: 2 </h2>
    <h2> Semester: 2 </h2>
    <h2> Total Credit Hour: <strong>21.25</strong></h2>
    <div class="col">
      <ul class="course">
        <li class="header">Computer & Communication Engineering</li>
        <li class="emph"><strong>Course Title: </strong>Digital Logic Design</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>CCE-221</li>
    ...
    <div class="col">
      <ul class="course">
        <li class="header">Computer & Communication Engineering</li>
        <li class="emph"><strong>Course Title: </strong>Database System</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>CCE-223</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        ...
        <li class="emph"><strong>Course Title: </strong> Mathematics-IV</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>MAT-221</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        <li class="header">AES</li>
        <li class="emph"><strong>Course Title: </strong>Government & Economics</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>AES-221</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        ...
        <li class="emph"><strong>Course Title: </strong>Information System Analysis & Design</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>CIT-221</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        ...
        <li><strong>Course Code: </strong>CIT-222</li>
    ...
    <div class="col">
      <ul class="course">
        <li class="header">Computer Science & Information Technology</li>
        <li class="emph"><strong>Course Title: </strong>Web Designing Project</li>
        <li><strong>Status: </strong>Sessional</li>
        <li><strong>Course Code: </strong>CIT-220</li>
        <li><strong>Credit Hour: </strong>1.50</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        ...
        <li class="emph"><strong>Course Title: </strong>Digital Logic Design</li>
        <li><strong>Status: </strong>Sessional</li>
        <li><strong>Course Code: </strong>CCE-222</li>
        <li><strong>Credit Hour: </strong>1.50</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        ...
        <li class="emph"><strong>Course Title: </strong>Database System</li>
        <li><strong>Status: </strong>Sessional</li>
        <li><strong>Course Code: </strong>CCE-224</li>
        <li><strong>Credit Hour: </strong>1.50</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
