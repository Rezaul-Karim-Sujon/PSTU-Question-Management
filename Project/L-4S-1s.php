...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Level-4 Semester-1</title>
  ...
  <body>
    ...
    <h2> Level: 4 </h2>
    <h2> Semester: 1 </h2>
    <h2> Total Credit Hour: <strong>22</strong></h2>
    <div class="col">
      <ul class="course">
        <li class="header">Computer & Communication Engineering</li>
        <li class="emph"><strong>Course Title: </strong> Algorithm Engineering</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>CCE-411</li>
    ...
    <div class="col">
      <ul class="course">
        <li class="header">Computer & Communication Engineering</li>
        <li class="emph"><strong>Course Title: </strong> VLSI Design</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>CCE-413</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        <li class="header">Computer & Communication Engineering</li>
        <li class="emph"><strong>Course Title: </strong>Network Routing & Switching</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>CCE-415</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        <li class="header">Computer & Communication Engineering</li>
        <li class="emph"><strong>Course Title: </strong> Data Warehousing & Mining</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>CCE-417</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        <li class="header">Computer & Communication Engineering</li>
        <li class="emph"><strong>Course Title: </strong>Compiler Design & Automata Theory</li>
        <li><strong>Status: </strong>Theoretical</li>
        <li><strong>Course Code: </strong>CCE-419</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        <li class="header">Computer & Communication Engineering</li>
        <li class="emph"><strong>Course Title: </strong> Computer Network & Switching</li>
        <li><strong>Status: </strong>Sessional</li>
        <li><strong>Course Code: </strong>CCE-416</li>
    ...
    <div class="col">
      <ul class="course">
        <li class="header">Computer & Communication Engineering</li>
        <li class="emph"><strong>Course Title: </strong>Compiler Design & Automata</li>
        <li><strong>Status: </strong>Sessional</li>
        <li><strong>Course Code: </strong>CCE-412</li>
        <li><strong>Credit Hour: </strong>1.50</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        ...
        <li><strong>Status: </strong>Sessional</li>
        <li><strong>Course Code: </strong>CSE-410</li>
        <li><strong>Credit Hour: </strong>3.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
    <div class="col">
      <ul class="course">
        <li class="header">CSE</li>
        <li class="emph"><strong>Course Title: </strong>Industrial Training</li>
        <li><strong>Status: </strong>Sessional</li>
        <li><strong>Course Code: </strong>CSE-412</li>
        <li><strong>Credit Hour: </strong>1.00</li>
        <li class="emph"><a href="#" class="button">Enter</a></li>
      </ul>
    </div>
  </div>
